...
namespace HawalaExchange.Application.Interfaces.Services
{
    ...
    {
        Task<DailyReportDto> GetDailyReportAsync(DateTime date, long branchId, long? currencyId = null);
        Task<IEnumerable<DailyReportDto>> GetDailyReportRangeAsync(DateTime fromDate, DateTime toDate, long? branchId = null, long? currencyId = null);
        Task<IEnumerable<TransactionReportDto>> GetTransactionReportAsync(DateTime fromDate, DateTime toDate, long? branchId = null, string? status = null, long? currencyId = null);
        Task<IEnumerable<CommissionReportDto>> GetCommissionReportAsync(DateTime fromDate, DateTime toDate, long? branchId = null, long? currencyId = null);
