...
public sealed class CorrespondentSettlementConversion : ITenantEntity
{
    ...
    public ICollection<CorrespondentSettlementConversionHawalaItem> HawalaItems { get; set; } = [];
}
...
public sealed class CorrespondentSettlementConversionHawalaItem : ITenantEntity
{
    [Key, DatabaseGenerated(DatabaseGeneratedOption.Identity)] public long Id { get; set; }
    public long TenantId { get; set; }
    public long ConversionId { get; set; }
