...
namespace HawalaExchange.Infrastructure.Migrations
{
    ...
    [Migration("20260925111435_AddPaymentLocationCommissionSnapshots")]
    partial class AddPaymentLocationCommissionSnapshots
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HawalaExchange.Domain.Entities.AccountCurrencyBalance", b =>
                {
                    b.Property<long>("TenantId")
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("TenantId", "AccountId", "CurrencyId");

                    b.HasIndex("TenantId", "CurrencyId");

                    b.ToTable("AccountCurrencyBalances");
                });
            ...
            modelBuilder.Entity("HawalaExchange.Domain.Entities.CorrespondentAccountPeriod", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("TenantId", "CorrespondentId", "PeriodNumber")
                        .IsUnique();

                    b.ToTable("CorrespondentAccountPeriods");
                });

            modelBuilder.Entity("HawalaExchange.Domain.Entities.CorrespondentAccountPeriodBalance", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("TenantId", "PeriodId", "CurrencyId")
                        .IsUnique();

                    b.ToTable("CorrespondentAccountPeriodBalances");
                });

            modelBuilder.Entity("HawalaExchange.Domain.Entities.CorrespondentAccountPeriodHawala", b =>
                {
                    b.Property<long>("PeriodId")
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("PeriodId", "HawalaId");

                    b.HasIndex("TenantId", "HawalaId");

                    b.HasIndex("TenantId", "PeriodId");

                    b.ToTable("CorrespondentAccountPeriodHawalas");
                });
            ...
            modelBuilder.Entity("HawalaExchange.Domain.Entities.CorrespondentCommissionBatchItem", b =>
                {
                    ...
                    b.Property<decimal?>("PerLakhRate")
                        .HasColumnType("decimal(18,4)");
            ...
            modelBuilder.Entity("HawalaExchange.Domain.Entities.CorrespondentDailyCommissionRate", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("TenantId", "CorrespondentId", "RateDate")
                        .IsUnique();

                    b.ToTable("CorrespondentDailyCommissionRates");
                });
            ...
            modelBuilder.Entity("HawalaExchange.Domain.Entities.DailyCommissionRate", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("DailyCommissionRates");
                });
            ...
            modelBuilder.Entity("HawalaExchange.Domain.Entities.Hawala", b =>
                {
                    ...
                    b.Property<decimal?>("CommissionBaseUsdAmount")
                        .HasColumnType("decimal(18,8)");

                    b.Property<long?>("CommissionCurrencyId")
                        .HasColumnType("bigint");

                    b.Property<decimal?>("CommissionUsdToAfnRate")
                        .HasColumnType("decimal(18,8)");

                    b.Property<DateTime?>("CommissionValuationDate")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("CommissionValuedAt")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("HawalaExchange.Domain.Entities.PaymentLocationCorrespondentAssignment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("TenantId", "CorrespondentId", "EffectiveFrom");

                    b.HasIndex("TenantId", "PaymentLocationId", "EffectiveFrom")
                        .IsUnique();

                    b.ToTable("PaymentLocationCorrespondentAssignments");
                });
            ...
            modelBuilder.Entity("HawalaExchange.Domain.Entities.CorrespondentAccountPeriodBalance", b =>
                {
                    ...
                    b.HasOne("HawalaExchange.Domain.Entities.CorrespondentAccountPeriod", "Period")
                        .WithMany("Balances")
